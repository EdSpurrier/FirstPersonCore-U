Shader "MACHIN3/Decals/Textured" 
{
	Properties 
	{
		...
		_SubSetColor ("Subset Color", Color) = (1, 1, 1)
	...
	SubShader 
	{
		...
		void surf (Input IN, inout SurfaceOutputStandard o) 
		{
            ...
            o.Albedo = lerp(lerp(0, subsetColor.rgb * _SubSetColor, aocurvheightsubset.a), _SimpleWearColor, GammaToLinearSpace(aocurvheightsubset.g) * _SimpleWear) * o.Occlusion;  // the inner lerp makes the albedo outside the subset mask black, instead of the subset color. black because its the color of AO. The outer lerp is for the SimpleWearColor
            o.Metallic = lerp(metalness.r *_Metalness, _SimpleWearMetalness, GammaToLinearSpace(aocurvheightsubset.g) * _SimpleWear) * o.Occlusion; // lerping SimpleWearMetalness as well as ensuring theres AO on metal, or rather no metal where ao is.
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) 
        {
            ...
            o.Normal = normal;
            o.Smoothness = lerp(metalness.a * _Smoothness, _SimpleWearSmoothness, GammaToLinearSpace(aocurvheightsubset.g) * _SimpleWear); // lerping SimpleWearSmoothness
	...
	FallBack "Diffuse"
    CustomEditor "M3DecalsTexturedEditor"
}
